...
if first_choice.lower() == 'knife':
    knife2= input("You now have a weapon but no light. A cougar snuck up on you and scratched you. Do you want to RUN or use your KNIFE to fight back?")
if knife2.lower() == 'run':
...
if knife2.lower() == 'knife':
    knife2= input("You slash the cougar several times and he's down. You keep walking and see some vines. Do you want to SWING or start a FIRE?")
if knife2.lower() == 'swing':
    print("Turns out your not a monkey and you fell straight into some trees and got hit and died. Game Over.")
elif knife2.lower() == 'fire':
...
if first_choice.lower() == 'flashlight':
    flashlight1= input("You picked up the flashlight and began walking through the now lit jungle. You avoid most dangers but are faced with a huge rock wall. Do you want to CLIMB, WALK AROUND or CALL for help?")
if flashlight1.lower() == 'climb':
...
if flashlight1.lower() == 'walk around':
...
print("Thank you for playing. Try again and pick new routes for a new adventure!")
